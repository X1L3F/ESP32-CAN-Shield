...
1. Attach CAN-Shield to ESP32 connect it to PC with the right USB-port and flash the Gateway-software. Before flashing, ensure you have included the Secret.h file in your project. Select your desired network mode in the software settings.
...
3. Configure the CAN Configurations on the WebServer.
